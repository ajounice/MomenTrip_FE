...
import "../../styles/components/ComponentModal.css"
import { RiCloseFill, RiSendPlane2Line } from 'react-icons/ri';
...
function CommentModal({isSelectComment , setIsSelectComment}:commentModal) : React.ReactElement{
