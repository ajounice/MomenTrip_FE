...
function InformationModal({isSelectedInfo,setIsSelectedInfo,isCollected,setIsCollected } : Props) : React.ReactElement{
    ...
    return(
        ...
        {/* tour info tag container */}
            ...
            <div className={"constrainShortFormContainer"}>
                <div className={"constrainShortFormInnerContainer"}>
                    {
                        // for Each constraint short form
                    }
